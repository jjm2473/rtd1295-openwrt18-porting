...
{var field=isElem(cbid)?cbid:document.getElementById(cbid);var validatorFn;try{var cbiValidator=L.validation.create(field,type,optional);validatorFn=cbiValidator.validate.bind(cbiValidator);}
...
function cbi_dropdown_init(sb){var dl=new L.ui.Dropdown(sb,null,{name:sb.getAttribute('name')});return dl.bind(sb);}
