...
writable_chroot=s:taboption("localuser",Flag,"allow_writeable_chroot",translate("Allow writable chroot"))
writable_chroot.rmempty=false
writable_chroot:depends("local_enable",1)
...
local_root=s:taboption("localuser",Value,"local_root",translate("Local Root"))
local_root.placeholder="/mnt"
local_root.rmempty=false
...
anon_world_read=s:taboption("anonymous",Flag,"anon_world_readable_only",translate("Download writable files only"))
anon_world_read.rmempty=false
anon_world_read:depends("anonymous_enable",1)
